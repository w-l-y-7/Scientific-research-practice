...
- refuses to exceed --max-records / --max-calls, and says so rather than
  truncating quietly
    ...
    python paginate.py --api biorxiv --query 2024-01-01/2024-01-03
    python paginate.py --api europepmc --query 'SRC:"PPR" AND "organoid"' --max-records 200
    python paginate.py --api openalex --query 'filter=publication_year:2024' --dry-run
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog="python %(prog)s --api biorxiv --query 2024-01-01/2024-01-03",
    )
