...
rebuilt.
    ...
    curl.exe -s "https://api.openalex.org/works/doi:10.7717/peerj.4375" | python openalex_abstract.py -
    python openalex_abstract.py results.json --text-only
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog='curl.exe -s "https://api.openalex.org/works/doi:10.7717/peerj.4375" | %(prog)s -',
    )
