...
`<article>`.
    ...
    curl.exe -s ".../efetch.fcgi?db=pmc&id=7029759&retmode=xml" | python jats_to_text.py -
    python jats_to_text.py article.xml --sections METHODS,RESULTS --text-only
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog="python %(prog)s article.xml --sections METHODS,RESULTS",
    )
